...
console.log("Min of (10, 1000, 32): " + findMin(10, 1000, 32));
console.log("Min of (1022, 23, 2): " + findMin(1022, 23, 2));
...
let threshold = 50;
console.log("Top student: " + getTopStudents(students, threshold));
...
console.log("Interest: " + calculateInterest(100000000, 10, 20));